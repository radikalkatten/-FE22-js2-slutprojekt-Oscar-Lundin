...
logOutBtn?.addEventListener('click', () => {document.cookie = "username=; expires=Thu, 01 Jan 1970 00:00:00 GMT; SameSite=None; Secure"; console.log(document.cookie); location.reload()})
